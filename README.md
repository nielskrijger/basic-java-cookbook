...
This Chef cookbook installs java on CentOS 6.5

This java cookbook has very limited configurability and likely you'll want to use
a community cookbook for your deployments instead.
